...
<div class="logo">
    ...
    <a href="{{ route('notifications.page') }}" class="notifications-icon">
...
<button id="theme-switch">
    <img id="dark-mode-icon" src="{{ asset('images/dark-mode.png') }}" alt="Dark Mode" style="display: none;">
    <img id="light-mode-icon" src="{{ asset('images/light-mode.png') }}" alt="Light Mode">
</button>-->
