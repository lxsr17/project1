                    ...
                    <div class="stores-header">
                        ...
                        <div class="stores-stats">
                            ...
                            <div class="sort-options">
                                <a href="{{ route('stores_login_Marchent', ['sort' => 'latest']) }}">الأحدث</a>
                    ...
                    <div class="stores-grid">
                        @forelse($stores as $store)
                            @php
                                ...
                                $hasRealLogo = $store->business_logo && file_exists(public_path('storage/' . ltrim($store->business_logo, '/')));
                                $logoPath     = $hasRealLogo ? asset('storage/' . ltrim($store->business_logo, '/')) : asset('images/placeholder.png');
                            @endphp
